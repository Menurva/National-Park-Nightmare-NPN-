...
public class SwingDoorOpen : MonoBehaviour
{
    ...
    {
        if (collision.transform.tag == "whatIsPlayer")
        {
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.E))
        {
            if (Action == true) //this occurs when player collides with the door's triggers
            {
                ...
                AnimeObject.GetComponent<Animator>().Play("SwingDoorOpen"); //this plays the door openning animation
